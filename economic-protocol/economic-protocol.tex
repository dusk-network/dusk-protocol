...
%    \date{\today}
    ...
    \quote{normal} contracts do, including having a state and calling other
    contracts in the \quote{normal contract} space.
    ...
    perceive right now.
    For the simple reason that in all \quote{normal} transactions, the block
    ...
    \quote{gamed} by some other executed transaction.
