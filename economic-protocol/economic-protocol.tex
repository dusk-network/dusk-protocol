...
%    \tableofcontents
    ...
    \begin{itemize}
        ...
        \item \provider: intermediary service entity between a
              \user and a \contract.
    	\item \transfercontract: the smart contract responsible for handling \dusk.
    ...
    developers/owners.
    Fantom\footnote{https://docs.fantom.foundation/funding/gas-monetization} and NEAR\footnote{https://wiki.dusk.network/org/roadmap/economic-model\#platform-pays-contracts} propose
